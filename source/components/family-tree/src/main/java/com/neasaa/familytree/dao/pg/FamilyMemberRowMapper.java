...
public class FamilyMemberRowMapper implements RowMapper<FamilyMemberEntity> {
  ...
  public FamilyMemberEntity mapRow(ResultSet aRs, int aRowNum) throws SQLException {
    ...
    familyMember.setImageLastUpdated(
        AbstractDao.getTimestampFromResultSet(aRs, "IMAGELASTUPDATED"));
    ...
    //		familyMember.setLastUpdatedDate(AbstractDao.getTimestampFromResultSet(aRs,
    // "LASTUPDATEDDATE"));
    return familyMember;
  }
}
