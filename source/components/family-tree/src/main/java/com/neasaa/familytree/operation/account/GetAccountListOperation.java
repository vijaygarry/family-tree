...
public class GetAccountListOperation
  ...
  @Override
  public GetAccountListResponse doExecute(EmptyOperationRequest opRequest)
      throws OperationException {
    GetAccountListResponse response = new GetAccountListResponse();
    GetAccountListResponse.AccountItem accountItem1 =
        new GetAccountListResponse.AccountItem("Samaj Application Account", 1);
    GetAccountListResponse.AccountItem accountItem2 =
        new GetAccountListResponse.AccountItem("Amravati Samaj Account", 2);
