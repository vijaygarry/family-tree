  ...
  public GetEventsResponse doExecute(GetEventsRequest opRequest) throws OperationException {
    ...
    event =
        EventDto.builder()
            ...
            .description(
                "With great pleasure, we invite you to the wedding of Someone and Someone. Please join us in celebrating this joyous occasion. All are invited.")
            .eventDate("2025-08-01")
            .eventTime("From 6:00 PM to 9:00 PM")
            .eventPlace(address)
            .eventOrganizer("Mr. Sanjayrao Deshmukh")
    ...
    event =
        EventDto.builder()
            ...
            .description(
                "With great sorrow, we announce the passing of Someone. Please join us in honoring their memory. All are invited.")
            .eventDate("2025-08-01")
            .eventTime("From 6:00 PM to 9:00 PM")
            .eventPlace(address)
            .eventOrganizer("Mr. Sanjayrao Deshmukh")
