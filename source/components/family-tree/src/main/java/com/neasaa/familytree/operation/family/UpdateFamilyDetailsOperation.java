...
@Scope("prototype")
public class UpdateFamilyDetailsOperation
    extends FamilyAbstractOperation<UpdateFamilyDetailsRequest, UpdateFamilyDetailsResponse> {
  ...
  public void doValidate(UpdateFamilyDetailsRequest opRequest) throws OperationException {
    ...
    FamilytreeValidationUtils.validateStringLength(
        opRequest.getFamilyNameInHindi(), "family name in Hindi", 100);
  ...
  public UpdateFamilyDetailsResponse doExecute(UpdateFamilyDetailsRequest opRequest)
    ...
    if (existingAddress == null) {
      ...
      throw new InternalServerException(
          "Internal exception occurred, please contact administrator.");
    }
    ...
    boolean canLoggedInUserUpdateFamily =
  ...
  private FamilyEntity getFamilyFromRequest(
    ...
    FamilyEntity familyEntity =
        FamilyEntity.builder()
            ...
            .lastUpdatedDate(auditInfo.getLastUpdatedDate())
            .build();
    familyEntity.setFamilysearchtext(
        DataFormatter.getFamilySearchString(familyEntity, headOfFamily, familyAddress));
    return familyEntity;
  }
}
