...
@Log4j2
public abstract class FamilyAbstractOperation<Request extends OperationRequest, Response extends OperationResponse> extends AbstractOperation<Request, Response> {
    ...
    @Autowired
    protected MemberRelationshipDao memberRelationshipDao;
