...
public class GetAccountStatementOperation
    extends AbstractOperation<GetAccountStatementRequest, GetAccountStatementResponse> {
  ...
  @Override
  public GetAccountStatementResponse doExecute(GetAccountStatementRequest opRequest)
    ...
    GetAccountStatementResponse.AccountDetails accountDetails =
        GetAccountStatementResponse.AccountDetails.builder()
    ...
    transactionList.add(
        getAccountTransaction(
            "TXN001", "2025-01-01", "Starting Balance", new BigDecimal("0.00"), 'C', startingBal));
    for (int i = 2; i < 22; i++) {
  ...
  private GetAccountStatementResponse.AccountTransaction getAccountTransaction(
